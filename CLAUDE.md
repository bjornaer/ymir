...
Go-style concurrency, and a **linearly typed quantum fragment** where no-cloning and
use-after-measurement are compile errors. Execution is a bytecode VM shipped as one
static binary.
